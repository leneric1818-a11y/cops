...
#SBATCH --gres=gpu:1
#SBATCH --qos=gpubasic
#SBATCH --output=logs/oncoco_classify_%j.out
#SBATCH --error=logs/oncoco_classify_%j.err

set -euo pipefail

echo "=================================================================="
echo "OnCoCo response classification at $(date)"
...
OUTPUT_PATH="${OUTPUT_PATH:-outputs/steering_eval/oncoco_labels.jsonl}"
