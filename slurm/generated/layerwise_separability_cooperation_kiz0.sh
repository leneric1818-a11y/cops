#!/bin/bash
#SBATCH --job-name=layersep_cooperation
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --partition=p0
...
DATA_PATH="${DATA_PATH:-outputs/metrics/persona_pairs_cooperation_gpt54mini_1000_flat.jsonl}"
...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/metrics/layerwise_separability_cooperation_gpt54mini_1000}"
STYLES="${STYLES:-resistant,cooperative}"
