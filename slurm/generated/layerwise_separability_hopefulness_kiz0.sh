#!/bin/bash
#SBATCH --job-name=layersep_hopefulness
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --partition=p6
...
DATA_PATH="${DATA_PATH:-outputs/metrics/persona_pairs_hopefulness_gpt54mini_1000_flat.jsonl}"
...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/metrics/layerwise_separability_hopefulness_gpt54mini_1000}"
STYLES="${STYLES:-resigned,hopeful}"
